...
class QueryProcessor(object):
    ...
    def melody2pianoRoll(self):
        ...
        TIV = None#self.computeTIV(chordMatrix)
        #print('4-')
...
class midiRender(melody_processor):
    ...
    def accomapnimentGeneration(self, piano_roll, pr_matrix, tempo=120):
        ...
        for idx in range(0, pr_matrix.shape[0]):
            #print(idx, piano_roll[idx], tempo, start)
            #print(self.numpy2melodyAndChord(matrix=piano_roll[idx], tempo=tempo, start_time=start))
